...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV CORR c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.CORR c.FA#c.CORR c.LVUL#c.CORR c.INEQ#c.CORR c.EXP#c.CORR c.LEL#c.CORR#c.IV c.FA#c.CORR#c.IV c.LVUL#c.CORR#c.IV c.INEQ#c.CORR#c.IV c.EXP#c.CORR#c.IV, lag(1)
est store eqrob12
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV GOVEFF, lag(1)
est store eqrob21
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV GOVEFF c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.GOVEFF c.FA#c.GOVEFF c.LVUL#c.GOVEFF c.INEQ#c.GOVEFF c.EXP#c.GOVEFF c.LEL#c.GOVEFF#c.IV c.FA#c.GOVEFF#c.IV c.LVUL#c.GOVEFF#c.IV c.INEQ#c.GOVEFF#c.IV c.EXP#c.GOVEFF#c.IV, lag(1)
est store eqrob22
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV POLST c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.POLST c.FA#c.POLST c.LVUL#c.POLST c.INEQ#c.POLST c.EXP#c.POLST c.LEL#c.POLST#c.IV c.FA#c.POLST#c.IV c.LVUL#c.POLST#c.IV c.INEQ#c.POLST#c.IV c.EXP#c.POLST#c.IV, lag(1)
est store eqrob32
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV REG, lag(1)
est store eqrob41
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV REG c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.REG c.FA#c.REG c.LVUL#c.REG c.INEQ#c.REG c.EXP#c.REG c.LEL#c.REG#c.IV c.FA#c.REG#c.IV c.LVUL#c.REG#c.IV c.INEQ#c.REG#c.IV c.EXP#c.REG#c.IV, lag(1)
est store eqrob42
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV RULE, lag(1)
est store eqrob51
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV RULE c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.RULE c.FA#c.RULE c.LVUL#c.RULE c.INEQ#c.RULE c.EXP#c.RULE c.LEL#c.RULE#c.IV c.FA#c.RULE#c.IV c.LVUL#c.RULE#c.IV c.INEQ#c.RULE#c.IV c.EXP#c.RULE#c.IV, lag(1)
est store eqrob52
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV VOICE, lag(1)
est store eqrob61
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP IV VOICE c.LEL#c.IV c.FA#c.IV c.LVUL#c.IV c.INEQ#c.IV c.EXP#c.IV c.LEL#c.VOICE c.FA#c.VOICE c.LVUL#c.VOICE c.INEQ#c.VOICE c.EXP#c.VOICE c.LEL#c.VOICE#c.IV c.FA#c.VOICE#c.IV c.LVUL#c.VOICE#c.IV c.INEQ#c.VOICE#c.IV c.EXP#c.VOICE#c.IV, lag(1)
est store eqrob62
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
