...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV CORR c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.CORR c.FA#c.CORR c.LVUL#c.CORR c.INEQ#c.CORR c.EXP#c.CORR c.LEL#c.CORR#c.HELV c.FA#c.CORR#c.HELV c.LVUL#c.CORR#c.HELV c.INEQ#c.CORR#c.HELV c.EXP#c.CORR#c.HELV, lag(1) 
est store eqrob12
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV GOVEFF c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.GOVEFF c.FA#c.GOVEFF c.LVUL#c.GOVEFF c.INEQ#c.GOVEFF c.EXP#c.GOVEFF c.LEL#c.GOVEFF#c.HELV c.FA#c.GOVEFF#c.HELV c.LVUL#c.GOVEFF#c.HELV c.INEQ#c.GOVEFF#c.HELV c.EXP#c.GOVEFF#c.HELV, lag(1) 
est store eqrob22
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV POLST c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.POLST c.FA#c.POLST c.LVUL#c.POLST c.INEQ#c.POLST c.EXP#c.POLST c.LEL#c.POLST#c.HELV c.FA#c.POLST#c.HELV c.LVUL#c.POLST#c.HELV c.INEQ#c.POLST#c.HELV c.EXP#c.POLST#c.HELV, lag(1) 
est store eqrob32
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV REG c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.REG c.FA#c.REG c.LVUL#c.REG c.INEQ#c.REG c.EXP#c.REG c.LEL#c.REG#c.HELV c.FA#c.REG#c.HELV c.LVUL#c.REG#c.HELV c.INEQ#c.REG#c.HELV c.EXP#c.REG#c.HELV, lag(1) 
est store eqrob42
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV RULE c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.RULE c.FA#c.RULE c.LVUL#c.RULE c.INEQ#c.RULE c.EXP#c.RULE c.LEL#c.RULE#c.HELV c.FA#c.RULE#c.HELV c.LVUL#c.RULE#c.HELV c.INEQ#c.RULE#c.HELV c.EXP#c.RULE#c.HELV, lag(1) 
est store eqrob52
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP HELV VOICE c.LEL#c.HELV c.FA#c.HELV c.LVUL#c.HELV c.INEQ#c.HELV c.EXP#c.HELV c.LEL#c.VOICE c.FA#c.VOICE c.LVUL#c.VOICE c.INEQ#c.VOICE c.EXP#c.VOICE c.LEL#c.VOICE#c.HELV c.FA#c.VOICE#c.HELV c.LVUL#c.VOICE#c.HELV c.INEQ#c.VOICE#c.HELV c.EXP#c.VOICE#c.HELV, lag(1) 
est store eqrob62
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est sto mrob12
