...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV CORR c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.CORR c.FA#c.CORR c.LVUL#c.CORR c.INEQ#c.CORR c.EXP#c.CORR c.LEL#c.CORR#c.FV c.FA#c.CORR#c.FV c.LVUL#c.CORR#c.FV c.INEQ#c.CORR#c.FV c.EXP#c.CORR#c.FV, lag(1)
est store eqrob12
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV GOVEFF c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.GOVEFF c.FA#c.GOVEFF c.LVUL#c.GOVEFF c.INEQ#c.GOVEFF c.EXP#c.GOVEFF c.LEL#c.GOVEFF#c.FV c.FA#c.GOVEFF#c.FV c.LVUL#c.GOVEFF#c.FV c.INEQ#c.GOVEFF#c.FV c.EXP#c.GOVEFF#c.FV, lag(1) 
est store eqrob22
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV POLST c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.POLST c.FA#c.POLST c.LVUL#c.POLST c.INEQ#c.POLST c.EXP#c.POLST c.LEL#c.POLST#c.FV c.FA#c.POLST#c.FV c.LVUL#c.POLST#c.FV c.INEQ#c.POLST#c.FV c.EXP#c.POLST#c.FV, lag(1) 
est store eqrob32
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV REG c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.REG c.FA#c.REG c.LVUL#c.REG c.INEQ#c.REG c.EXP#c.REG c.LEL#c.REG#c.FV c.FA#c.REG#c.FV c.LVUL#c.REG#c.FV c.INEQ#c.REG#c.FV c.EXP#c.REG#c.FV, lag(1) 
est store eqrob42
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV RULE c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.RULE c.FA#c.RULE c.LVUL#c.RULE c.INEQ#c.RULE c.EXP#c.RULE c.LEL#c.RULE#c.FV c.FA#c.RULE#c.FV c.LVUL#c.RULE#c.FV c.INEQ#c.RULE#c.FV c.EXP#c.RULE#c.FV, lag(1) 
est store eqrob52
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
...
set more off
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob11
quietly: xtpraisk LSDG711 LEL FA LVUL INEQ EXP FV VOICE c.LEL#c.FV c.FA#c.FV c.LVUL#c.FV c.INEQ#c.FV c.EXP#c.FV c.LEL#c.VOICE c.FA#c.VOICE c.LVUL#c.VOICE c.INEQ#c.VOICE c.EXP#c.VOICE c.LEL#c.VOICE#c.FV c.FA#c.VOICE#c.FV c.LVUL#c.VOICE#c.FV c.INEQ#c.VOICE#c.FV c.EXP#c.VOICE#c.FV, lag(1) 
est store eqrob62
quietly: margins, dydx(LEL FA LVUL INEQ EXP) post
est store mrob12
