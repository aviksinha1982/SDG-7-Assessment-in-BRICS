...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV CORR c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.CORR c.FA#c.CORR c.PS#c.CORR c.LPCI#c.CORR c.URB#c.CORR c.LREN#c.CORR#c.FV c.FA#c.CORR#c.FV c.PS#c.CORR#c.FV c.LPCI#c.CORR#c.FV c.URB#c.CORR#c.FV, lag(1) 
est store eqrob12
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV GOVEFF c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.GOVEFF c.FA#c.GOVEFF c.PS#c.GOVEFF c.LPCI#c.GOVEFF c.URB#c.GOVEFF c.LREN#c.GOVEFF#c.FV c.FA#c.GOVEFF#c.FV c.PS#c.GOVEFF#c.FV c.LPCI#c.GOVEFF#c.FV c.URB#c.GOVEFF#c.FV, lag(1) 
est store eqrob22
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV POLST c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.POLST c.FA#c.POLST c.PS#c.POLST c.LPCI#c.POLST c.URB#c.POLST c.LREN#c.POLST#c.FV c.FA#c.POLST#c.FV c.PS#c.POLST#c.FV c.LPCI#c.POLST#c.FV c.URB#c.POLST#c.FV, lag(1) 
est store eqrob32
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV REG c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.REG c.FA#c.REG c.PS#c.REG c.LPCI#c.REG c.URB#c.REG c.LREN#c.REG#c.FV c.FA#c.REG#c.FV c.PS#c.REG#c.FV c.LPCI#c.REG#c.FV c.URB#c.REG#c.FV, lag(1) 
est store eqrob42
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV RULE c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.RULE c.FA#c.RULE c.PS#c.RULE c.LPCI#c.RULE c.URB#c.RULE c.LREN#c.RULE#c.FV c.FA#c.RULE#c.FV c.PS#c.RULE#c.FV c.LPCI#c.RULE#c.FV c.URB#c.RULE#c.FV, lag(1) 
est store eqrob52
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB FV VOICE c.LREN#c.FV c.FA#c.FV c.PS#c.FV c.LPCI#c.FV c.URB#c.FV c.LREN#c.VOICE c.FA#c.VOICE c.PS#c.VOICE c.LPCI#c.VOICE c.URB#c.VOICE c.LREN#c.VOICE#c.FV c.FA#c.VOICE#c.FV c.PS#c.VOICE#c.FV c.LPCI#c.VOICE#c.FV c.URB#c.VOICE#c.FV, lag(1) 
est store eqrob62
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
