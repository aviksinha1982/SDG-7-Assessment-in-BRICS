...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV CORR c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.CORR c.FA#c.CORR c.PS#c.CORR c.LPCI#c.CORR c.URB#c.CORR c.LREN#c.CORR#c.WV c.FA#c.CORR#c.WV c.PS#c.CORR#c.WV c.LPCI#c.CORR#c.WV c.URB#c.CORR#c.WV, lag(1) 
est store eqrob12
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV GOVEFF c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.GOVEFF c.FA#c.GOVEFF c.PS#c.GOVEFF c.LPCI#c.GOVEFF c.URB#c.GOVEFF c.LREN#c.GOVEFF#c.WV c.FA#c.GOVEFF#c.WV c.PS#c.GOVEFF#c.WV c.LPCI#c.GOVEFF#c.WV c.URB#c.GOVEFF#c.WV, lag(1) 
est store eqrob22
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV POLST c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.POLST c.FA#c.POLST c.PS#c.POLST c.LPCI#c.POLST c.URB#c.POLST c.LREN#c.POLST#c.WV c.FA#c.POLST#c.WV c.PS#c.POLST#c.WV c.LPCI#c.POLST#c.WV c.URB#c.POLST#c.WV, lag(1) 
est store eqrob32
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV REG c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.REG c.FA#c.REG c.PS#c.REG c.LPCI#c.REG c.URB#c.REG c.LREN#c.REG#c.WV c.FA#c.REG#c.WV c.PS#c.REG#c.WV c.LPCI#c.REG#c.WV c.URB#c.REG#c.WV, lag(1) 
est store eqrob42
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV RULE c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.RULE c.FA#c.RULE c.PS#c.RULE c.LPCI#c.RULE c.URB#c.RULE c.LREN#c.RULE#c.WV c.FA#c.RULE#c.WV c.PS#c.RULE#c.WV c.LPCI#c.RULE#c.WV c.URB#c.RULE#c.WV, lag(1) 
est store eqrob52
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB WV VOICE c.LREN#c.WV c.FA#c.WV c.PS#c.WV c.LPCI#c.WV c.URB#c.WV c.LREN#c.VOICE c.FA#c.VOICE c.PS#c.VOICE c.LPCI#c.VOICE c.URB#c.VOICE c.LREN#c.VOICE#c.WV c.FA#c.VOICE#c.WV c.PS#c.VOICE#c.WV c.LPCI#c.VOICE#c.WV c.URB#c.VOICE#c.WV, lag(1) 
est store eqrob62
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
