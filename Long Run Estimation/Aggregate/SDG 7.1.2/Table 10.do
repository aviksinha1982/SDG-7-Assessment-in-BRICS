...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV CORR c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.CORR c.FA#c.CORR c.PS#c.CORR c.LPCI#c.CORR c.URB#c.CORR c.LREN#c.CORR#c.IV c.FA#c.CORR#c.IV c.PS#c.CORR#c.IV c.LPCI#c.CORR#c.IV c.URB#c.CORR#c.IV, lag(1) 
est store eqrob12
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV GOVEFF c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.GOVEFF c.FA#c.GOVEFF c.PS#c.GOVEFF c.LPCI#c.GOVEFF c.URB#c.GOVEFF c.LREN#c.GOVEFF#c.IV c.FA#c.GOVEFF#c.IV c.PS#c.GOVEFF#c.IV c.LPCI#c.GOVEFF#c.IV c.URB#c.GOVEFF#c.IV, lag(1) 
est store eqrob22
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV POLST c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.POLST c.FA#c.POLST c.PS#c.POLST c.LPCI#c.POLST c.URB#c.POLST c.LREN#c.POLST#c.IV c.FA#c.POLST#c.IV c.PS#c.POLST#c.IV c.LPCI#c.POLST#c.IV c.URB#c.POLST#c.IV, lag(1) 
est store eqrob32
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV REG c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.REG c.FA#c.REG c.PS#c.REG c.LPCI#c.REG c.URB#c.REG c.LREN#c.REG#c.IV c.FA#c.REG#c.IV c.PS#c.REG#c.IV c.LPCI#c.REG#c.IV c.URB#c.REG#c.IV, lag(1) 
est store eqrob42
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV RULE c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.RULE c.FA#c.RULE c.PS#c.RULE c.LPCI#c.RULE c.URB#c.RULE c.LREN#c.RULE#c.IV c.FA#c.RULE#c.IV c.PS#c.RULE#c.IV c.LPCI#c.RULE#c.IV c.URB#c.RULE#c.IV, lag(1) 
est store eqrob52
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB IV VOICE c.LREN#c.IV c.FA#c.IV c.PS#c.IV c.LPCI#c.IV c.URB#c.IV c.LREN#c.VOICE c.FA#c.VOICE c.PS#c.VOICE c.LPCI#c.VOICE c.URB#c.VOICE c.LREN#c.VOICE#c.IV c.FA#c.VOICE#c.IV c.PS#c.VOICE#c.IV c.LPCI#c.VOICE#c.IV c.URB#c.VOICE#c.IV, lag(1) 
est store eqrob62
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
