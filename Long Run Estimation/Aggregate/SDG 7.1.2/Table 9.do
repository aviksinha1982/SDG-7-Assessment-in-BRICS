...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV CORR c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.CORR c.FA#c.CORR c.PS#c.CORR c.LPCI#c.CORR c.URB#c.CORR c.LREN#c.CORR#c.HELV c.FA#c.CORR#c.HELV c.PS#c.CORR#c.HELV c.LPCI#c.CORR#c.HELV c.URB#c.CORR#c.HELV, lag(1) 
est store eqrob12
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV GOVEFF c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.GOVEFF c.FA#c.GOVEFF c.PS#c.GOVEFF c.LPCI#c.GOVEFF c.URB#c.GOVEFF c.LREN#c.GOVEFF#c.HELV c.FA#c.GOVEFF#c.HELV c.PS#c.GOVEFF#c.HELV c.LPCI#c.GOVEFF#c.HELV c.URB#c.GOVEFF#c.HELV, lag(1) 
est store eqrob22
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV POLST c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.POLST c.FA#c.POLST c.PS#c.POLST c.LPCI#c.POLST c.URB#c.POLST c.LREN#c.POLST#c.HELV c.FA#c.POLST#c.HELV c.PS#c.POLST#c.HELV c.LPCI#c.POLST#c.HELV c.URB#c.POLST#c.HELV, lag(1) 
est store eqrob32
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV REG c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.REG c.FA#c.REG c.PS#c.REG c.LPCI#c.REG c.URB#c.REG c.LREN#c.REG#c.HELV c.FA#c.REG#c.HELV c.PS#c.REG#c.HELV c.LPCI#c.REG#c.HELV c.URB#c.REG#c.HELV, lag(1) 
est store eqrob42
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV RULE c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.RULE c.FA#c.RULE c.PS#c.RULE c.LPCI#c.RULE c.URB#c.RULE c.LREN#c.RULE#c.HELV c.FA#c.RULE#c.HELV c.PS#c.RULE#c.HELV c.LPCI#c.RULE#c.HELV c.URB#c.RULE#c.HELV, lag(1) 
est store eqrob52
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob11
quietly: xtpraisk LSDG712 LREN FA PS LPCI URB HELV VOICE c.LREN#c.HELV c.FA#c.HELV c.PS#c.HELV c.LPCI#c.HELV c.URB#c.HELV c.LREN#c.VOICE c.FA#c.VOICE c.PS#c.VOICE c.LPCI#c.VOICE c.URB#c.VOICE c.LREN#c.VOICE#c.HELV c.FA#c.VOICE#c.HELV c.PS#c.VOICE#c.HELV c.LPCI#c.VOICE#c.HELV c.URB#c.VOICE#c.HELV, lag(1) 
est store eqrob62
quietly: margins, dydx(LREN FA PS LPCI URB) post
est sto mrob12
