...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV CORR c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.CORR c.LINN#c.CORR c.FDI#c.CORR c.LIND#c.CORR c.LED#c.CORR c.PS#c.CORR#c.FV c.LINN#c.CORR#c.FV c.FDI#c.CORR#c.FV c.LIND#c.CORR#c.FV c.LED#c.CORR#c.FV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV GOVEFF c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FDI#c.GOVEFF c.LIND#c.GOVEFF c.LED#c.GOVEFF c.PS#c.GOVEFF#c.FV c.LINN#c.GOVEFF#c.FV c.FDI#c.GOVEFF#c.FV c.LIND#c.GOVEFF#c.FV c.LED#c.GOVEFF#c.FV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV POLST c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.POLST c.LINN#c.POLST c.FDI#c.POLST c.LIND#c.POLST c.LED#c.POLST c.PS#c.POLST#c.FV c.LINN#c.POLST#c.FV c.FDI#c.POLST#c.FV c.LIND#c.POLST#c.FV c.LED#c.POLST#c.FV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV REG c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.REG c.LINN#c.REG c.FDI#c.REG c.LIND#c.REG c.LED#c.REG c.PS#c.REG#c.FV c.LINN#c.REG#c.FV c.FDI#c.REG#c.FV c.LIND#c.REG#c.FV c.LED#c.REG#c.FV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV RULE c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.RULE c.LINN#c.RULE c.FDI#c.RULE c.LIND#c.RULE c.LED#c.RULE c.PS#c.RULE#c.FV c.LINN#c.RULE#c.FV c.FDI#c.RULE#c.FV c.LIND#c.RULE#c.FV c.LED#c.RULE#c.FV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED FV VOICE c.PS#c.FV c.LINN#c.FV c.FDI#c.FV c.LIND#c.FV c.LED#c.FV c.PS#c.VOICE c.LINN#c.VOICE c.FDI#c.VOICE c.LIND#c.VOICE c.LED#c.VOICE c.PS#c.VOICE#c.FV c.LINN#c.VOICE#c.FV c.FDI#c.VOICE#c.FV c.LIND#c.VOICE#c.FV c.LED#c.VOICE#c.FV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
