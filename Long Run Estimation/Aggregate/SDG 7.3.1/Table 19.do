...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV CORR c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.CORR c.LINN#c.CORR c.FDI#c.CORR c.LIND#c.CORR c.LED#c.CORR c.PS#c.CORR#c.HELV c.LINN#c.CORR#c.HELV c.FDI#c.CORR#c.HELV c.LIND#c.CORR#c.HELV c.LED#c.CORR#c.HELV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV GOVEFF c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FDI#c.GOVEFF c.LIND#c.GOVEFF c.LED#c.GOVEFF c.PS#c.GOVEFF#c.HELV c.LINN#c.GOVEFF#c.HELV c.FDI#c.GOVEFF#c.HELV c.LIND#c.GOVEFF#c.HELV c.LED#c.GOVEFF#c.HELV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV POLST c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.POLST c.LINN#c.POLST c.FDI#c.POLST c.LIND#c.POLST c.LED#c.POLST c.PS#c.POLST#c.HELV c.LINN#c.POLST#c.HELV c.FDI#c.POLST#c.HELV c.LIND#c.POLST#c.HELV c.LED#c.POLST#c.HELV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV REG c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.REG c.LINN#c.REG c.FDI#c.REG c.LIND#c.REG c.LED#c.REG c.PS#c.REG#c.HELV c.LINN#c.REG#c.HELV c.FDI#c.REG#c.HELV c.LIND#c.REG#c.HELV c.LED#c.REG#c.HELV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV RULE c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.RULE c.LINN#c.RULE c.FDI#c.RULE c.LIND#c.RULE c.LED#c.RULE c.PS#c.RULE#c.HELV c.LINN#c.RULE#c.HELV c.FDI#c.RULE#c.HELV c.LIND#c.RULE#c.HELV c.LED#c.RULE#c.HELV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED HELV VOICE c.PS#c.HELV c.LINN#c.HELV c.FDI#c.HELV c.LIND#c.HELV c.LED#c.HELV c.PS#c.VOICE c.LINN#c.VOICE c.FDI#c.VOICE c.LIND#c.VOICE c.LED#c.VOICE c.PS#c.VOICE#c.HELV c.LINN#c.VOICE#c.HELV c.FDI#c.VOICE#c.HELV c.LIND#c.VOICE#c.HELV c.LED#c.VOICE#c.HELV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
