...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV CORR c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.CORR c.LINN#c.CORR c.FDI#c.CORR c.LIND#c.CORR c.LED#c.CORR c.PS#c.CORR#c.WV c.LINN#c.CORR#c.WV c.FDI#c.CORR#c.WV c.LIND#c.CORR#c.WV c.LED#c.CORR#c.WV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV GOVEFF c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FDI#c.GOVEFF c.LIND#c.GOVEFF c.LED#c.GOVEFF c.PS#c.GOVEFF#c.WV c.LINN#c.GOVEFF#c.WV c.FDI#c.GOVEFF#c.WV c.LIND#c.GOVEFF#c.WV c.LED#c.GOVEFF#c.WV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV POLST c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.POLST c.LINN#c.POLST c.FDI#c.POLST c.LIND#c.POLST c.LED#c.POLST c.PS#c.POLST#c.WV c.LINN#c.POLST#c.WV c.FDI#c.POLST#c.WV c.LIND#c.POLST#c.WV c.LED#c.POLST#c.WV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV REG c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.REG c.LINN#c.REG c.FDI#c.REG c.LIND#c.REG c.LED#c.REG c.PS#c.REG#c.WV c.LINN#c.REG#c.WV c.FDI#c.REG#c.WV c.LIND#c.REG#c.WV c.LED#c.REG#c.WV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV RULE c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.RULE c.LINN#c.RULE c.FDI#c.RULE c.LIND#c.RULE c.LED#c.RULE c.PS#c.RULE#c.WV c.LINN#c.RULE#c.WV c.FDI#c.RULE#c.WV c.LIND#c.RULE#c.WV c.LED#c.RULE#c.WV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED WV VOICE c.PS#c.WV c.LINN#c.WV c.FDI#c.WV c.LIND#c.WV c.LED#c.WV c.PS#c.VOICE c.LINN#c.VOICE c.FDI#c.VOICE c.LIND#c.VOICE c.LED#c.VOICE c.PS#c.VOICE#c.WV c.LINN#c.VOICE#c.WV c.FDI#c.VOICE#c.WV c.LIND#c.VOICE#c.WV c.LED#c.VOICE#c.WV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
