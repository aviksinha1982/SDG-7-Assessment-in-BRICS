...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV CORR c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.CORR c.LINN#c.CORR c.FDI#c.CORR c.LIND#c.CORR c.LED#c.CORR c.PS#c.CORR#c.IV c.LINN#c.CORR#c.IV c.FDI#c.CORR#c.IV c.LIND#c.CORR#c.IV c.LED#c.CORR#c.IV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV GOVEFF c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FDI#c.GOVEFF c.LIND#c.GOVEFF c.LED#c.GOVEFF c.PS#c.GOVEFF#c.IV c.LINN#c.GOVEFF#c.IV c.FDI#c.GOVEFF#c.IV c.LIND#c.GOVEFF#c.IV c.LED#c.GOVEFF#c.IV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV POLST c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.POLST c.LINN#c.POLST c.FDI#c.POLST c.LIND#c.POLST c.LED#c.POLST c.PS#c.POLST#c.IV c.LINN#c.POLST#c.IV c.FDI#c.POLST#c.IV c.LIND#c.POLST#c.IV c.LED#c.POLST#c.IV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV REG c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.REG c.LINN#c.REG c.FDI#c.REG c.LIND#c.REG c.LED#c.REG c.PS#c.REG#c.IV c.LINN#c.REG#c.IV c.FDI#c.REG#c.IV c.LIND#c.REG#c.IV c.LED#c.REG#c.IV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV RULE c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.RULE c.LINN#c.RULE c.FDI#c.RULE c.LIND#c.RULE c.LED#c.RULE c.PS#c.RULE#c.IV c.LINN#c.RULE#c.IV c.FDI#c.RULE#c.IV c.LIND#c.RULE#c.IV c.LED#c.RULE#c.IV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED IV VOICE c.PS#c.IV c.LINN#c.IV c.FDI#c.IV c.LIND#c.IV c.LED#c.IV c.PS#c.VOICE c.LINN#c.VOICE c.FDI#c.VOICE c.LIND#c.VOICE c.LED#c.VOICE c.PS#c.VOICE#c.IV c.LINN#c.VOICE#c.IV c.FDI#c.VOICE#c.IV c.LIND#c.VOICE#c.IV c.LED#c.VOICE#c.IV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
