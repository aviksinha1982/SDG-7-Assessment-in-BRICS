...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV CORR c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.CORR c.LINN#c.CORR c.FDI#c.CORR c.LIND#c.CORR c.LED#c.CORR c.PS#c.CORR#c.EV c.LINN#c.CORR#c.EV c.FDI#c.CORR#c.EV c.LIND#c.CORR#c.EV c.LED#c.CORR#c.EV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV GOVEFF c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FDI#c.GOVEFF c.LIND#c.GOVEFF c.LED#c.GOVEFF c.PS#c.GOVEFF#c.EV c.LINN#c.GOVEFF#c.EV c.FDI#c.GOVEFF#c.EV c.LIND#c.GOVEFF#c.EV c.LED#c.GOVEFF#c.EV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV POLST c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.POLST c.LINN#c.POLST c.FDI#c.POLST c.LIND#c.POLST c.LED#c.POLST c.PS#c.POLST#c.EV c.LINN#c.POLST#c.EV c.FDI#c.POLST#c.EV c.LIND#c.POLST#c.EV c.LED#c.POLST#c.EV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV REG c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.REG c.LINN#c.REG c.FDI#c.REG c.LIND#c.REG c.LED#c.REG c.PS#c.REG#c.EV c.LINN#c.REG#c.EV c.FDI#c.REG#c.EV c.LIND#c.REG#c.EV c.LED#c.REG#c.EV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV RULE c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.RULE c.LINN#c.RULE c.FDI#c.RULE c.LIND#c.RULE c.LED#c.RULE c.PS#c.RULE#c.EV c.LINN#c.RULE#c.EV c.FDI#c.RULE#c.EV c.LIND#c.RULE#c.EV c.LED#c.RULE#c.EV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob11
quietly: xtpraisk LSDG731 PS LINN FDI LIND LED EV VOICE c.PS#c.EV c.LINN#c.EV c.FDI#c.EV c.LIND#c.EV c.LED#c.EV c.PS#c.VOICE c.LINN#c.VOICE c.FDI#c.VOICE c.LIND#c.VOICE c.LED#c.VOICE c.PS#c.VOICE#c.EV c.LINN#c.VOICE#c.EV c.FDI#c.VOICE#c.EV c.LIND#c.VOICE#c.EV c.LED#c.VOICE#c.EV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FDI LIND LED) post
est sto mrob12
