...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV CORR c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.CORR c.LINN#c.CORR c.FD#c.CORR c.NEI#c.CORR c.LCT#c.CORR c.PS#c.CORR#c.HELV c.LINN#c.CORR#c.HELV c.FD#c.CORR#c.HELV c.NEI#c.CORR#c.HELV c.LCT#c.CORR#c.HELV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV GOVEFF c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FD#c.GOVEFF c.NEI#c.GOVEFF c.LCT#c.GOVEFF c.PS#c.GOVEFF#c.HELV c.LINN#c.GOVEFF#c.HELV c.FD#c.GOVEFF#c.HELV c.NEI#c.GOVEFF#c.HELV c.LCT#c.GOVEFF#c.HELV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV POLST c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.POLST c.LINN#c.POLST c.FD#c.POLST c.NEI#c.POLST c.LCT#c.POLST c.PS#c.POLST#c.HELV c.LINN#c.POLST#c.HELV c.FD#c.POLST#c.HELV c.NEI#c.POLST#c.HELV c.LCT#c.POLST#c.HELV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV REG c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.REG c.LINN#c.REG c.FD#c.REG c.NEI#c.REG c.LCT#c.REG c.PS#c.REG#c.HELV c.LINN#c.REG#c.HELV c.FD#c.REG#c.HELV c.NEI#c.REG#c.HELV c.LCT#c.REG#c.HELV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV RULE c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.RULE c.LINN#c.RULE c.FD#c.RULE c.NEI#c.RULE c.LCT#c.RULE c.PS#c.RULE#c.HELV c.LINN#c.RULE#c.HELV c.FD#c.RULE#c.HELV c.NEI#c.RULE#c.HELV c.LCT#c.RULE#c.HELV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT HELV VOICE c.PS#c.HELV c.LINN#c.HELV c.FD#c.HELV c.NEI#c.HELV c.LCT#c.HELV c.PS#c.VOICE c.LINN#c.VOICE c.FD#c.VOICE c.NEI#c.VOICE c.LCT#c.VOICE c.PS#c.VOICE#c.HELV c.LINN#c.VOICE#c.HELV c.FD#c.VOICE#c.HELV c.NEI#c.VOICE#c.HELV c.LCT#c.VOICE#c.HELV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
