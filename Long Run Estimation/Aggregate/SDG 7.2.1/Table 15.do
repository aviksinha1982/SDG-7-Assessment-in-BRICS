...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV CORR c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.CORR c.LINN#c.CORR c.FD#c.CORR c.NEI#c.CORR c.LCT#c.CORR c.PS#c.CORR#c.IV c.LINN#c.CORR#c.IV c.FD#c.CORR#c.IV c.NEI#c.CORR#c.IV c.LCT#c.CORR#c.IV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV GOVEFF c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FD#c.GOVEFF c.NEI#c.GOVEFF c.LCT#c.GOVEFF c.PS#c.GOVEFF#c.IV c.LINN#c.GOVEFF#c.IV c.FD#c.GOVEFF#c.IV c.NEI#c.GOVEFF#c.IV c.LCT#c.GOVEFF#c.IV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV POLST c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.POLST c.LINN#c.POLST c.FD#c.POLST c.NEI#c.POLST c.LCT#c.POLST c.PS#c.POLST#c.IV c.LINN#c.POLST#c.IV c.FD#c.POLST#c.IV c.NEI#c.POLST#c.IV c.LCT#c.POLST#c.IV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV REG c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.REG c.LINN#c.REG c.FD#c.REG c.NEI#c.REG c.LCT#c.REG c.PS#c.REG#c.IV c.LINN#c.REG#c.IV c.FD#c.REG#c.IV c.NEI#c.REG#c.IV c.LCT#c.REG#c.IV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV RULE c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.RULE c.LINN#c.RULE c.FD#c.RULE c.NEI#c.RULE c.LCT#c.RULE c.PS#c.RULE#c.IV c.LINN#c.RULE#c.IV c.FD#c.RULE#c.IV c.NEI#c.RULE#c.IV c.LCT#c.RULE#c.IV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT IV VOICE c.PS#c.IV c.LINN#c.IV c.FD#c.IV c.NEI#c.IV c.LCT#c.IV c.PS#c.VOICE c.LINN#c.VOICE c.FD#c.VOICE c.NEI#c.VOICE c.LCT#c.VOICE c.PS#c.VOICE#c.IV c.LINN#c.VOICE#c.IV c.FD#c.VOICE#c.IV c.NEI#c.VOICE#c.IV c.LCT#c.VOICE#c.IV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
