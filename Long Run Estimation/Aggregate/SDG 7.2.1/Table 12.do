...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV CORR c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.CORR c.LINN#c.CORR c.FD#c.CORR c.NEI#c.CORR c.LCT#c.CORR c.PS#c.CORR#c.EV c.LINN#c.CORR#c.EV c.FD#c.CORR#c.EV c.NEI#c.CORR#c.EV c.LCT#c.CORR#c.EV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV GOVEFF c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FD#c.GOVEFF c.NEI#c.GOVEFF c.LCT#c.GOVEFF c.PS#c.GOVEFF#c.EV c.LINN#c.GOVEFF#c.EV c.FD#c.GOVEFF#c.EV c.NEI#c.GOVEFF#c.EV c.LCT#c.GOVEFF#c.EV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV POLST c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.POLST c.LINN#c.POLST c.FD#c.POLST c.NEI#c.POLST c.LCT#c.POLST c.PS#c.POLST#c.EV c.LINN#c.POLST#c.EV c.FD#c.POLST#c.EV c.NEI#c.POLST#c.EV c.LCT#c.POLST#c.EV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV REG c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.REG c.LINN#c.REG c.FD#c.REG c.NEI#c.REG c.LCT#c.REG c.PS#c.REG#c.EV c.LINN#c.REG#c.EV c.FD#c.REG#c.EV c.NEI#c.REG#c.EV c.LCT#c.REG#c.EV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV RULE c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.RULE c.LINN#c.RULE c.FD#c.RULE c.NEI#c.RULE c.LCT#c.RULE c.PS#c.RULE#c.EV c.LINN#c.RULE#c.EV c.FD#c.RULE#c.EV c.NEI#c.RULE#c.EV c.LCT#c.RULE#c.EV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT EV VOICE c.PS#c.EV c.LINN#c.EV c.FD#c.EV c.NEI#c.EV c.LCT#c.EV c.PS#c.VOICE c.LINN#c.VOICE c.FD#c.VOICE c.NEI#c.VOICE c.LCT#c.VOICE c.PS#c.VOICE#c.EV c.LINN#c.VOICE#c.EV c.FD#c.VOICE#c.EV c.NEI#c.VOICE#c.EV c.LCT#c.VOICE#c.EV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
