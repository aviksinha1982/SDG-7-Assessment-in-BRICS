...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV CORR c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.CORR c.LINN#c.CORR c.FD#c.CORR c.NEI#c.CORR c.LCT#c.CORR c.PS#c.CORR#c.FV c.LINN#c.CORR#c.FV c.FD#c.CORR#c.FV c.NEI#c.CORR#c.FV c.LCT#c.CORR#c.FV, lag(1) 
est store eqrob12
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV GOVEFF, lag(1) 
est store eqrob21
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV GOVEFF c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FD#c.GOVEFF c.NEI#c.GOVEFF c.LCT#c.GOVEFF c.PS#c.GOVEFF#c.FV c.LINN#c.GOVEFF#c.FV c.FD#c.GOVEFF#c.FV c.NEI#c.GOVEFF#c.FV c.LCT#c.GOVEFF#c.FV, lag(1) 
est store eqrob22
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV POLST c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.POLST c.LINN#c.POLST c.FD#c.POLST c.NEI#c.POLST c.LCT#c.POLST c.PS#c.POLST#c.FV c.LINN#c.POLST#c.FV c.FD#c.POLST#c.FV c.NEI#c.POLST#c.FV c.LCT#c.POLST#c.FV, lag(1) 
est store eqrob32
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV REG, lag(1) 
est store eqrob41
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV REG c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.REG c.LINN#c.REG c.FD#c.REG c.NEI#c.REG c.LCT#c.REG c.PS#c.REG#c.FV c.LINN#c.REG#c.FV c.FD#c.REG#c.FV c.NEI#c.REG#c.FV c.LCT#c.REG#c.FV, lag(1) 
est store eqrob42
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV RULE, lag(1) 
est store eqrob51
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV RULE c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.RULE c.LINN#c.RULE c.FD#c.RULE c.NEI#c.RULE c.LCT#c.RULE c.PS#c.RULE#c.FV c.LINN#c.RULE#c.FV c.FD#c.RULE#c.FV c.NEI#c.RULE#c.FV c.LCT#c.RULE#c.FV, lag(1) 
est store eqrob52
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV VOICE, lag(1) 
est store eqrob61
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT FV VOICE c.PS#c.FV c.LINN#c.FV c.FD#c.FV c.NEI#c.FV c.LCT#c.FV c.PS#c.VOICE c.LINN#c.VOICE c.FD#c.VOICE c.NEI#c.VOICE c.LCT#c.VOICE c.PS#c.VOICE#c.FV c.LINN#c.VOICE#c.FV c.FD#c.VOICE#c.FV c.NEI#c.VOICE#c.FV c.LCT#c.VOICE#c.FV, lag(1) 
est store eqrob62
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
