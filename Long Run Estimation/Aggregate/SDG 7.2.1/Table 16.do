...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV CORR, lag(1)
est store eqrob11
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV CORR c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.CORR c.LINN#c.CORR c.FD#c.CORR c.NEI#c.CORR c.LCT#c.CORR c.PS#c.CORR#c.WV c.LINN#c.CORR#c.WV c.FD#c.CORR#c.WV c.NEI#c.CORR#c.WV c.LCT#c.CORR#c.WV, lag(1)
est store eqrob12
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV GOVEFF, lag(1)
est store eqrob21
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV GOVEFF c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.GOVEFF c.LINN#c.GOVEFF c.FD#c.GOVEFF c.NEI#c.GOVEFF c.LCT#c.GOVEFF c.PS#c.GOVEFF#c.WV c.LINN#c.GOVEFF#c.WV c.FD#c.GOVEFF#c.WV c.NEI#c.GOVEFF#c.WV c.LCT#c.GOVEFF#c.WV, lag(1)
est store eqrob22
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV POLST, lag(1)
est store eqrob31
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV POLST c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.POLST c.LINN#c.POLST c.FD#c.POLST c.NEI#c.POLST c.LCT#c.POLST c.PS#c.POLST#c.WV c.LINN#c.POLST#c.WV c.FD#c.POLST#c.WV c.NEI#c.POLST#c.WV c.LCT#c.POLST#c.WV, lag(1)
est store eqrob32
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV REG, lag(1)
est store eqrob41
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV REG c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.REG c.LINN#c.REG c.FD#c.REG c.NEI#c.REG c.LCT#c.REG c.PS#c.REG#c.WV c.LINN#c.REG#c.WV c.FD#c.REG#c.WV c.NEI#c.REG#c.WV c.LCT#c.REG#c.WV, lag(1)
est store eqrob42
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV RULE, lag(1)
est store eqrob51
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV RULE c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.RULE c.LINN#c.RULE c.FD#c.RULE c.NEI#c.RULE c.LCT#c.RULE c.PS#c.RULE#c.WV c.LINN#c.RULE#c.WV c.FD#c.RULE#c.WV c.NEI#c.RULE#c.WV c.LCT#c.RULE#c.WV, lag(1)
est store eqrob52
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
...
set more off
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV VOICE, lag(1)
est store eqrob61
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob11
quietly: xtpraisk LSDG721 PS LINN FD NEI LCT WV VOICE c.PS#c.WV c.LINN#c.WV c.FD#c.WV c.NEI#c.WV c.LCT#c.WV c.PS#c.VOICE c.LINN#c.VOICE c.FD#c.VOICE c.NEI#c.VOICE c.LCT#c.VOICE c.PS#c.VOICE#c.WV c.LINN#c.VOICE#c.WV c.FD#c.VOICE#c.WV c.NEI#c.VOICE#c.WV c.LCT#c.VOICE#c.WV, lag(1)
est store eqrob62
quietly: margins, dydx(PS LINN FD NEI LCT) post
est sto mrob12
